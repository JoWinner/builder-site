...
import { HiGlobe, HiLocationMarker, HiPhone } from "react-icons/hi";
            ...
            <div className="absolute backdrop-blur-sm bg-white/30  shadow-lg py-10 md:py-12 px-4 md:px-6  -mt-36">
              <div className="grid md:grid-cols-3  lg:grid-cols-3 gap-x-6 ">
                <div className="mb-6 lg:mb-0 text-center mx-auto ">
                  <HiGlobe className="text-4xl mx-auto mb-4 " />
                  <h2 className="font-medium text-lg ">Liberia States</h2>
                </div>
                <div className="mb-6 lg:mb-0 text-center mx-auto">
                  <HiLocationMarker className="text-4xl mx-auto mb-4" />
                  <h2 className="font-medium text-lg">Libreville, 94126</h2>
                </div>
                <div className="mb-6 md:mb-0 text-center mx-auto">
                  <HiPhone className="text-4xl mx-auto mb-4" />
                  <h2 className="font-medium text-lg">+ 01 234 567 89</h2>
                </div>
              </div>
              <h1 className="mx-auto my-5  flex justify-center font-semibold text-lg md:text-2xl text-gray-800">
              ...
              <div className=" flex flex-row justify-evenly my-5">
                <a
                  ...
                  rel="noreferrer"
                >
                  <FaFacebookMessenger className="text-[#0099FF]  text-5xl" />
                </a>
                <a
                  ...
                  rel="noreferrer"
                >
                  <FaWhatsappSquare className="text-[#25D366] text-5xl" />
                </a>
                <FaFacebookSquare className="text-[#1877F2] text-5xl" />
              </div>
